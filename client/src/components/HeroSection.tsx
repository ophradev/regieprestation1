export default function HeroSection() {
  return (
    <section id="accueil" className="relative bg-gradient-to-r from-primary to-emerald-800 text-white py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -right-5 bg-white p-3 rounded-lg shadow-lg">
              <div className="flex items-center space-x-2 text-togo-dark">
                <i className="fas fa-robot text-primary text-xl"></i>
                <p className="font-medium">Assistant IA disponible 24/7</p>
              </div>
            </div>
          </div>
        </div>
